...
COPY ./config/dataserver-scripts/delete-entry-files.sh /var/www/zotero/admin/delete-entry-files.sh
COPY ./config/dataserver-scripts/get-delete-list.sh /var/www/zotero/admin/get-delete-list.sh
